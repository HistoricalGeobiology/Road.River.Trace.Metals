...
Noah J. Planavsky, Justin V. Strauss.

Before running the R scripts included, download this folder and set it as your R working directory. 
...
All other packages can be installed from CRAN. These scripts have been tested using R version 3.6.2 - 
